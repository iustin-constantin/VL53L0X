 ...
 *  This library is based on VL53L0X-STM32F103 provided by MarcelMG
 *  and updated for stm32F0 family
 *  https://github.com/MarcelMG/VL53L0X-STM32F103/blob/master/VL53L0X.c
 */
...
uint32_t VL53L0X_readReg32Bit(struct VL53L0X* dev, uint8_t reg)
{
	...
	uint8_t buf[4];
	I2c_vWrite(dev->address, &reg, 1);
	dev->last_status = I2c_vRead(dev->address, buf, 4);
